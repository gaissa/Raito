...
?>
  ...
  <li class="listing-card col-sm-6 col-md-<?php echo $cols;?> <?php if(osc_item_is_premium()){ echo ' premium'; } ?>">
    <div class="figure">
      ...
      <article>
      <span class="category"><i class="fa fa-<?php echo raito_teema_category_icon( osc_item_category_id() ); ?>"></i> <?php echo osc_item_category() ; ?></span> <span class="location"><i class="fa fa-map-marker"></i><?php echo osc_item_city(); ?>
