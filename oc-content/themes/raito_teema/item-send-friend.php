<?php
    ...
    raito_teema_add_body_class('contact');
...
<div class="row">
  <div class="col-md-4 col-md-offset-4">
    <div class="wraps">
      <div class="title">
        <h1>
          <?php _e('Send to a friend', raito_teema_THEME_FOLDER); ?>
        </h1>
      </div>
        ...
        <form name="sendfriend" action="<?php echo osc_base_url(true); ?>" method="post" >
          ...
          <div class="form-group">
            <label class="control-label" for="friendName">
              <?php _e("Your friend's name",raito_teema_THEME_FOLDER); ?>
            </label>
            <div class="controls">
          ...
          <div class="form-group">
            <label for="friendEmail">
              <?php _e("Your friend's e-mail address", raito_teema_THEME_FOLDER); ?>
            </label>
            </label>
            <div class="controls">
          ...
          <div class="form-group">
            <label class="control-label" for="subject">
              <?php _e('Subject (optional)', raito_teema_THEME_FOLDER); ?>
            </label>
            <div class="controls">
