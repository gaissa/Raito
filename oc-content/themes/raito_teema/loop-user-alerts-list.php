          ...
          <div class="info">
            <div class="detail_info">
              ...
              <div class="rate_me rate_me_star">
                <?php raito_teema_item_star_rating( osc_item_id() ); ?>
                <span><?php echo raito_teema_item_avg_rating( osc_item_id()) ; ?></span> </div>
              <?php } ?>
        ...
        <div class="col-sm-8 col-md-8">
          <div class="info">
            <div class="detail_info">
              ...
              <?php if( is_voting_enabled() ){ ?>
              <div class="rate_me rate_me_star">
                <?php raito_teema_item_star_rating( osc_itemosc_premium_id() ); ?>
                <span><?php echo raito_teema_item_avg_rating( osc_premium_id()) ; ?></span> </div>
              <?php } ?>
              <div class="attribute_list"> <span class="category"><i class="fa fa-<?php echo raito_teema_category_icon( osc_premium_category_id() ); ?>"></i><?php echo osc_premium_category() ; ?></span> <span class="location"><i class="fa fa-map-marker"></i> <?php echo osc_premium_city(); ?>
