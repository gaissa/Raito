...
<?php $colorMode = osc_get_preference('theme_color_mode', 'raito_teema_theme');?>
<?php $google_fonts = osc_get_preference('google_fonts', 'raito_teema_theme');?>
<h2 class="render-title"><?php _e('Theme Style', raito_teema_THEME_FOLDER); ?></h2>
<form action="<?php echo osc_admin_render_theme_url('oc-content/themes/'.raito_teema_THEME_FOLDER.'/admin/settings.php');?>" method="post" enctype="multipart/form-data" class="nocsrf">
    <input type="hidden" name="action_specific" value="theme_style" />
	<fieldset>
		<div class="form-horizontal">
			<div class="form-row">
                <div class="form-label"><?php _e('Theme color mode', raito_teema_THEME_FOLDER); ?></div>
                <div class="form-controls">
                    <select name="theme_color_mode">
                        <option value="green" <?php if($colorMode == 'green'){ echo 'selected="selected"' ; } ?>><?php echo osc_esc_html(__('Green',raito_teema_THEME_FOLDER));?></option>
                        <option value="dark-green" <?php if($colorMode == 'dark-green'){ echo 'selected="selected"' ; } ?>><?php  echo osc_esc_html(__('Dark Green',raito_teema_THEME_FOLDER));?></option>
                        <option value="red" <?php if($colorMode == 'red'){ echo 'selected="selected"' ; } ?>><?php  echo osc_esc_html(__('Red',raito_teema_THEME_FOLDER));?></option>
                        <option value="vivid-red" <?php if($colorMode == 'vivid-red'){ echo 'selected="selected"' ; } ?>><?php  echo osc_esc_html(__('Vivid Red',raito_teema_THEME_FOLDER));?></option>
                        <option value="blue" <?php if($colorMode == 'blue'){ echo 'selected="selected"' ; } ?>><?php  echo osc_esc_html(__('Blue',raito_teema_THEME_FOLDER));?></option>
                        <option value="light-blue" <?php if($colorMode == 'light-blue'){ echo 'selected="selected"' ; } ?>><?php  echo osc_esc_html(__('Light Blue',raito_teema_THEME_FOLDER));?></option>
                        <option value="orange" <?php if($colorMode == 'orange'){ echo 'selected="selected"' ; } ?>><?php  echo osc_esc_html(__('Orange',raito_teema_THEME_FOLDER));?></option>
                        <option value="gray" <?php if($colorMode == 'gray'){ echo 'selected="selected"' ; } ?>><?php  echo osc_esc_html(__('Gray',raito_teema_THEME_FOLDER));?></option>
					    <option value="purple" <?php if($colorMode == 'purple'){ echo 'selected="selected"' ; } ?>><?php  echo osc_esc_html(__('Purple',raito_teema_THEME_FOLDER));?></option>
                        <option value="yellow" <?php if($colorMode == 'yellow'){ echo 'selected="selected"' ; } ?>><?php  echo osc_esc_html(__('Yellow',raito_teema_THEME_FOLDER));?></option>
                    </select>
                </div>
			</div>
			<div class="form-row">
                <div class="form-label"><?php _e('Google fonts', raito_teema_THEME_FOLDER); ?></div>
                <div class="form-controls">
            ...
            <div class="form-row">
                <div class="form-label"><?php _e('RTL view', raito_teema_THEME_FOLDER); ?></div>
                <div class="form-controls">
					<div class="form-label-checkbox">
						<input type="checkbox" name="rtl_view" value="1" <?php echo (osc_esc_html( osc_get_preference('rtl_view', 'raito_teema_theme') ) == "1")? "checked": ""; ?>>
						<br>
						<div class="help-box"><?php _e('Right to left view.', raito_teema_THEME_FOLDER); ?></div>
					</div>
				</div>
            </div>
            <div class="form-row">
                <div class="form-label"><?php _e('Custom CSS', raito_teema_THEME_FOLDER); ?></div>
                <div class="form-controls">
                    <textarea style="height: 115px; width: 500px;"name="custom_css"><?php echo osc_esc_html( osc_get_preference('custom_css', 'raito_teema_theme') ); ?></textarea>
                    <br/><br/>
                    <div class="help-box"><?php _e('You can write your custom CSS and override the default CSS.', raito_teema_THEME_FOLDER); ?></div>
                </div>
            </div>			
			<div class="form-actions">
				<input id="button" type="submit" value="<?php echo osc_esc_html(__('Save changes',raito_teema_THEME_FOLDER)); ?>" class="btn btn-submit">
			</div>
		</div>
	</fieldset>
</form>